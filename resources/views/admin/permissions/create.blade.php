    ...
    <div class="container">
        <form action="{{route('admin.permissions.store')}}" method="POST">
            ...
            <div class="form-floating">
                <input type="text" class="form-control" name="name" placeholder="permission...." style="width: 500px"/>
            ...
            <button class="btn btn-success rounded-pill p-3" style="margin-block: 1rem">Create permission</button>
        </form>
    </div>
